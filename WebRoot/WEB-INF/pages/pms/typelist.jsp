...
<body>
	...
	<div id="main_content">
		...
		<div class="center_content">
			...
			<a href="${path }/pms/product/findByType?page=1&type=${type}">首页</a> 
			<a href="${path }/pms/product/findByType?page=${pageBean.page-1}&type=${type}">上一页</a>
			</c:if>
			<c:if test="${pageBean.page != pageBean.totalPage}">
			<a href="${path }/pms/product/findByType?page=${pageBean.page+1}&type=${type}">下一页</a>
			<a href="${path }/pms/product/findByType?page=${pageBean.totalPage}&type=${type}">末页</a>
			</c:if>
			</div>
