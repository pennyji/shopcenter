...
<body>
	...
	<div id="main_content">
		...
		<div class="center_content">
			...
			<a href="${path }/pms/product/findByListHot?page=1">首页</a> 
			<a href="${path }/pms/product/findByListHot?page=${pageBean.page-1}">上一页</a>
			</c:if>
			<c:if test="${pageBean.page != pageBean.totalPage}">
			<a href="${path }/pms/product/findByListHot?page=${pageBean.page+1}">下一页</a>
			<a href="${path }/pms/product/findByListHot?page=${pageBean.totalPage}">末页</a>
			</c:if>
			</div>
